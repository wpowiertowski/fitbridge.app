...
struct WelcomeView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("Welcome to HealthLoom")
                .font(.largeTitle.bold())
                .multilineTextAlignment(.center)
            Text("HealthLoom brings your Fitbit or Pixel Watch data -- steps, heart rate, weight, and sleep -- into Apple Health, so all your health data lives in one place.")
                .font(.body)
